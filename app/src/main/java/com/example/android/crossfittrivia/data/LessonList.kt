...
class LessonList {
    ...
    companion object {
        val lessons: MutableList<Lesson> = mutableListOf(
            Lesson(false, "AMRAP means:", "An AMRAP session focuses on pushing yourself as much as possible during a set time frame; it can form part of a bigger routine (a 10-minute AMRAP 'burn' at the end, for example) or it could be your whole workout.", ""),
            ...
            Lesson(false, "CFWU means", "CrossFit Warm UP: Warm muscles perform better and faster in both the concentric and eccentric motion, as opposed to cold muscles. Giving you more power and strength while decreasing the chance of injury. By creating a light sweat it will prep your body to cool more quickly once the work begins and strain on the heart will be decreased by the ability of the blood to move more rapidly.", ""),
